...
public class DayNightSwitch extends View implements Checkable {
    ...
    private static final int DEFAULT_WIDTH = 86;      //width of SwitchButton
    ...
    private final int spotOnColorIn;
    private int spotOffColor;
    private final int spotOffColorIn;
...
//        drawRoundRect(canvas, color, ovalShadeOnAttrs);
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        void onCheckedChanged(DayNightSwitch s, boolean isChecked);
    }
}
